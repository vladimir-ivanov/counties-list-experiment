...
NOTES: 
the only info about the capital is its name?
population of capital city is possibly a mistake? the only population given on all api calls is country one?

needs eslint!

clarify how to display country details - popup etc